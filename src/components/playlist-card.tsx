...
const VARIANT_STYLES: Record<PlaylistCardVariant, string> = {
  featured:
    "rounded-xl border border-border/80 bg-card/70 p-4 transition hover:-translate-y-px hover:border-foreground/25 hover:bg-card/90 hover:shadow-sm",
  dashboard:
    "rounded-2xl border border-border/70 bg-card/70 p-5 shadow-[0_1px_0_0_rgba(0,0,0,0.03)] transition hover:-translate-y-0.5 hover:border-foreground/25 hover:shadow-sm",
};

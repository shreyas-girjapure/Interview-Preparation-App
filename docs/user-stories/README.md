# Interview Preparation App - User Stories Backlog
...
- `epics/` contains epic-level goals and scope.
- `stories/` contains individual user stories with acceptance criteria.
